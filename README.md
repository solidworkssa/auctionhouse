# 18-auctionhouse - Base Native Architecture
...
Auctionhouse provides a decentralized solution for sealed bid auctions with reveal mechanism on both Base (EVM) and Stacks blockchains.
